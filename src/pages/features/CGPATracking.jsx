          ...
          <div className="space-y-6 order-1">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-light-text-secondary dark:text-dark-text-secondary">
                Our comprehensive CGPA tracking system helps you stay on top of
                your academic performance with detailed insights and progress
                monitoring tools.
              </p>
              ...
              <ul className="space-y-4 text-light-text-secondary dark:text-dark-text-secondary">
                <li className="flex items-start">
                  ...
                  <span>
                    Real-time GPA calculator with semester-wise breakdown
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span>Visual progress tracking with interactive charts</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="h-6 w-6 text-light-accent dark:text-dark-accent mt-0.5 mr-2"
                  ...
                  <span>Performance predictions and goal setting tools</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="h-6 w-6 text-light-accent dark:text-dark-accent mt-0.5 mr-2"
                  ...
                  <span>Customizable grade scale and weighting system</span>
                </li>
              </ul>
            </div>
            <div className="pt-6">
